                        ...
                        <div class="stat-content">
                            <div class="text-left dib">
                                <div class="stat-text">Rp.
                                    <span class="count">123901212</span>
                                </div>
    ...
    <div class="orders">
        <div class="row">
            <div class="col-xl-8">
                <div class="card">
                    <div class="card-body">
                        <h4 class="box-title">Pembelian Terbaru
                        </h4>
                    </div>
                    <div class="card-body--">
                            ...
                            <table class="table ">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="product">Uniqlo</span>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="product">Pull&Bear</span>
                                        </td>
                                        <td>
                                            <span class="count">1</span>
                                        </td>
                                    ...
                                    <tr class=" pb-0">
                                        ...
                                        <td>
                                            <span class="product">Bershka</span>
                                        </td>
                                        <td>
                                            <span class="count">1</span>
                                        </td>
                                    ...
                                    <tr class=" pb-0">
                                        ...
                                        <td>
                                            <span class="name">Kim Ratchet</span>
                                        </td>
                                        <td>
                                            <span class="product">Nama</span>
                                        </td>
                                        <td>
                                            <span class="count">1</span>
                                        </td>
